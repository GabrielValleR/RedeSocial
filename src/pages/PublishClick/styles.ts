...
export const IconCloseTag = styled.Image.attrs({
  resizeMode: 'contain',
})`
  width: ${RFValue(16)}px;
  height: ${RFValue(16)}px;
...
export const InputTags = styled(TextInput).attrs<TextInputProps>({})`
  flex: 1;
  font-family: ${theme.fonts.inter.medium};
  font-size: ${RFValue(16)}px;
  line-height: ${RFValue(19.36)}px;
...
export const ContainerTextTags = styled.View`
  margin-left: ${RFValue(8)}px;
`;

export const ContainerInputTags = styled.View`
  flex-direction: row;
...
export const TextInputTags = styled.Text`
  font-family: ${theme.fonts.inter.medium};
  font-size: ${RFValue(16)}px;
...
export const ContainerCloseTag = styled.View`
  padding-right: ${RFValue(8)}px;
  padding-left: ${RFValue(3)}px;
`;

export const TouchableCloseTag = styled.TouchableOpacity``;

export const ContainerAllTags = styled.View`
